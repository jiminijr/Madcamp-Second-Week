...
import { View, TextInput, ScrollView, Image, StyleSheet, Text, ImageBackground, TouchableOpacity } from 'react-native';
...
<ImageBackground
  ...
  >
        <View style={styles.firstContainer}>
          <FastImage
            source={require('../../assets/images/1st.gif')}
          ...
          <FastImage
            source={require('../../assets/images/2nd.gif')}
            style={styles.firstimage}
            resizeMode="contain"
          />
        ...
        <View style={styles.thirdContainer}>
          <FastImage
            source={require('../../assets/images/3rd.gif')}
            style={styles.firstimage}
            resizeMode="contain"
          />
        <FastImage
        ...
        <View style={styles.textContainer}>
          <Text style={styles.blackBoxText}>조연출</Text>
        </View>
      </View>
